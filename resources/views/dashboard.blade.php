                            ...
                            <div class="panel-heading panel-tabs">
                                <ul class="nav nav-tabs nav-float" role="tablist">
                                    ...
                                    <li class="text-center">
                                        <a href="#profile" role="tab" data-toggle="tab"><span
                                                class="hidden-xs">Annual</span>
                                            Revenue</a>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade in active" id="home">
                                        <div class="form-group">
                                            <input type="checkbox" id="toggle_real" name="my-checkbox" data-size="small"
                                                checked>
                                        </div>
                                    ...
                                    <ul class="timeline timeline-update">
                                        <li>
                                            <div class="timeline-badge primary wow lightSpeedIn center">
                                                <img src="{{asset('clear/img/authors/avatar1.jpg')}}" height="36"
                                                    width="36" class="img-circle pull-right" alt="avatar-image">
                                            </div>
                                        ...
                                        <li>
                                            <div class="timeline-badge info wow lightSpeedIn center">
                                                <img src="{{asset('clear/img/authors/avatar.jpg')}}" height="36"
                                                    width="36" class="img-circle pull-right" alt="avatar-image">
                                            </div>
                                        ...
                                        <li>
                                            <div class="timeline-badge default wow lightSpeedIn center">
                                                <img src="{{asset('clear/img/authors/avatar2.jpg')}}" height="36"
                                                    width="36" class="img-circle pull-right" alt="avatar-image">
                                            </div>
                                            <div class="timeline-panel wow slideInLeft">
                                                <div class="timeline-heading">
                                        ...
                                        <li>
                                            <div class="timeline-badge primary wow lightSpeedIn center">
                                                <img src="{{asset('clear/img/authors/avatar3.jpg')}}" height="36"
                                                    width="36" class="img-circle pull-right" alt="avatar-image">
                                        ...
                                        <li>
                                            <div class="timeline-badge info wow lightSpeedIn center">
                                                <img src="{{asset('clear/img/authors/avatar4.jpg')}}" height="36"
                                                    width="36" class="img-circle pull-right" alt="avatar-image">
                        ...
                        <div class="panel personal-chat">
                            <div class="panel-heading">
                                <div class="panel-title"><img class="chat-image img-circle pull-left" height="36"
                                        width="36" src="{{asset('clear/img/authors/avatar5.jpg')}}" alt="avatar-image">
                                        ...
                                        <div class="pull-right options">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <li><a href="#"><i class="ti-gallery text-primary"></i>Gallery</a>
                                                    </li>
                                                    <li><a href="#"><i
                                                                class="ti-location-arrow text-primary"></i>Location</a>
                                                    </li>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 m-b-15">
                                                <div class="input-group text-field">
                                                    <input type="search" class="form-control chat-input custom_textbox"
                                                        id="custom_textbox" placeholder="Type a message" required>
                                                    <span class="input-group-btn">
                                                        <button class="btn btn-success send-btn" type="submit"><i
                                    ...
                                    <ul class="list-unstyled margin-none">
                                        <li class="rightsidebar-contact-wrapper">
                                            <a class="rightsidebar-contact" href="#">
                                                <img src="{{asset('clear/img/authors/avatar6.jpg')}}"
                                        ...
                                        <li class="rightsidebar-contact-wrapper">
                                            <a class="rightsidebar-contact" href="#">
                                                <img src="{{asset('clear/img/authors/avatar.jpg')}}"
                                                    class="img-circle pull-right" alt="avatar-image">
                                                <i class="fa fa-circle text-xs text-primary"></i>
                                                Jordan
                                            </a>
                                        ...
                                        <li class="rightsidebar-contact-wrapper">
                                            <a class="rightsidebar-contact" href="#">
                                                <img src="{{asset('clear/img/authors/avatar2.jpg')}}"
                                                    class="img-circle pull-right" alt="avatar-image">
                                                <i class="fa fa-circle text-xs text-primary"></i>
                                                Stewart
                                            </a>
                                        ...
                                        <li class="rightsidebar-contact-wrapper">
                                            <a class="rightsidebar-contact" href="#">
                                                <img src="{{asset('clear/img/authors/avatar3.jpg')}}"
                                                    class="img-circle pull-right" alt="avatar-image">
                                        ...
                                        <li class="rightsidebar-contact-wrapper">
                                            <a class="rightsidebar-contact" href="#">
                                                <img src="{{asset('clear/img/authors/avatar4.jpg')}}"
                                                    class="img-circle pull-right" alt="avatar-image">
                                        ...
                                        <li class="rightsidebar-contact-wrapper">
                                            <a class="rightsidebar-contact" href="#">
                                                <img src="{{asset('clear/img/authors/avatar5.jpg')}}"
                                                    class="img-circle pull-right" alt="avatar-image">
                                        ...
                                        <li class="rightsidebar-contact-wrapper">
                                            <a class="rightsidebar-contact" href="#">
                                                <img src="{{asset('clear/img/authors/avatar7.jpg')}}"
                                                    class="img-circle pull-right" alt="avatar-image">
                                                <i class="fa fa-circle text-xs text-muted"></i>
                                                Cassandra
                                            </a>
                                    ...
                                    <ul class="list-unstyled m-t-15 notifications">
                                        <li>
                                            <a href="#" class="message icon-not striped-col">
                                                <img class="message-image img-circle"
                                                    src="{{asset('clear/img/authors/avatar3.jpg')}}" alt="avatar-image">
                                        ...
                                        <li>
                                            <a href="#" class="message icon-not">
                                                <img class="message-image img-circle"
                                                    src="{{asset('clear/img/authors/avatar.jpg')}}" alt="avatar-image">
                                                <div class="message-body">
                                                    <strong>Tony</strong>
                                                    <br>
                                        ...
                                        <li>
                                            <a href="#" class="message icon-not striped-col">
                                                <img class="message-image img-circle"
                                                    src="{{asset('clear/img/authors/avatar6.jpg')}}" alt="avatar-image">
                                        ...
                                        <li>
                                            <a href="#" class="message icon-not">
                                                <img class="message-image img-circle"
                                                    src="{{asset('clear/img/authors/avatar1.jpg')}}" alt="avatar-image">
                                                <div class="message-body">
                                        ...
                                        <li>
                                            <a href="#" class="message icon-not striped-col">
                                                <img class="message-image img-circle"
                                                    src="{{asset('clear/img/authors/avatar7.jpg')}}" alt="avatar-image">
...
<script type="text/javascript" src="{{asset('clear/js/custom_js/sparkline/jquery.flot.spline.js')}}"></script>
<!-- flip --->
<script type="text/javascript" src="{{asset('clear/vendors/flip/js/jquery.flip.min.js')}}"></script>
<script type="text/javascript" src="{{asset('clear/vendors/lcswitch/js/lc_switch.min.js')}}"></script>
<!--flot chart-->
<script type="text/javascript" src="{{asset('clear/vendors/flotchart/js/jquery.flot.js')}}"></script>
<script type="text/javascript" src="{{asset('clear/vendors/flotchart/js/jquery.flot.resize.js')}}"></script>
<script type="text/javascript" src="{{asset('clear/vendors/flotchart/js/jquery.flot.stack.js')}}"></script>
<script type="text/javascript" src="{{asset('clear/vendors/flotspline/js/jquery.flot.spline.min.js')}}"></script>
<script type="text/javascript" src="{{asset('clear/vendors/flot.tooltip/js/jquery.flot.tooltip.js')}}"></script>
<!--swiper-->
<script type="text/javascript" src="{{asset('clear/vendors/swiper/js/swiper.min.js')}}"></script>
<!--chartjs-->
<script src="{{asset('clear/vendors/chartjs/js/Chart.js')}}"></script>
<!--nvd3 chart-->
<script type="text/javascript" src="{{asset('clear/js/nvd3/d3.v3.min.js')}}"></script>
<script type="text/javascript" src="{{asset('clear/vendors/nvd3/js/nv.d3.min.js')}}"></script>
<script type="text/javascript" src="{{asset('clear/vendors/moment/js/moment.min.js')}}"></script>
<script type="text/javascript" src="{{asset('clear/vendors/advanced_newsTicker/js/newsTicker.js')}}"></script>
<script type="text/javascript" src="{{asset('clear/js/dashboard1.js')}}"></script>
@endsection